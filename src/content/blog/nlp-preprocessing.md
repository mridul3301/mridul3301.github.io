...
excerpt: "Walkthrough of NLP preprocessing steps-data cleaning, tokenization, and preparing text for modeling."
...
Tokenization is the process of breaking down the large text data into smaller pieces known as _tokens_. Assume that we have a text with 1000 words, we first divide the text into sentences and then sentences to tokens(words in this case).
...
In the figure above, we can see that lemmatizer identified the name _walker_ and kept it as it is while stemmers changed it into walk.<br>
<br>
